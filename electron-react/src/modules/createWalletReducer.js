export const CREATE_AP_WALLET_OPTIONS = "CREATE_AP_WALLET_OPTIONS";
export const CREATE_AUTHORIZER_AP = "CREATE_AUTHORIZER_AP";
export const CREATE_SPENDER_AP = "CREATE_SPENDER_AP";
